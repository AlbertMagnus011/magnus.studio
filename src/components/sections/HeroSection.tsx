...
export const HeroSection = () => {
    return (
        <section className="w-full bg-[#4ddbb5] border-2 border-b-[#c5f1b0]" >
            <div className="container mx-auto flex flex-col md:flex-row p-8 md:p-16 gap-8">
                ...
                <div className="flex basis-4/7 justify-center items-center">
                    ...
                    className="object-contain rotate-4 hover:scale-105 hover:rotate-0 transition-transform duration-700 "/>
                </div>
            </div>
        </section>
    )
